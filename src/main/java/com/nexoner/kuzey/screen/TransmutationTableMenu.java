...
public class TransmutationTableMenu extends AbstractContainerMenu {
    ...
    public TransmutationTableMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.TRANSMUTATION_TABLE_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((TransmutationTableBlockEntity) entity);
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0,74,54));
            this.addSlot(new ModResultSlot(handler, 1,74,15));
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.TRANSMUTATION_TABLE.get());
    }
