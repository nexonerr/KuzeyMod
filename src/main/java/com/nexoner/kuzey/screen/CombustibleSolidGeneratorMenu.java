...
import com.nexoner.kuzey.screen.slot.ModFuelSlot;
...
public class CombustibleSolidGeneratorMenu extends AbstractContainerMenu implements IEnergyMenu {
    public final CombustibleSolidGeneratorBlockEntity blockEntity;
    private final Level level;
    public final ContainerData data;

    public CombustibleSolidGeneratorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(6));
    }
    public CombustibleSolidGeneratorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.COMBUSTIBLE_SOLID_GENERATOR_MENU.get(), pContainerId);
        checkContainerSize(inv, 1);
        blockEntity = ((CombustibleSolidGeneratorBlockEntity) entity);
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new ModFuelSlot(handler, 0,87,37));
        });
    ...
    public int getEnergyBarScale(){
        ...
        int maxEnergy = KuzeyCommonConfigs.combustibleSolidGeneratorCapacity.get();
        int energyBarSize = 40;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.COMBUSTIBLE_SOLID_GENERATOR.get());
    }
