...
public class EmreEssenceGeneratorMenu extends AbstractContainerMenu implements IFluidMenu, IEnergyMenu {
    ...
    public EmreEssenceGeneratorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(6));
    }
    public EmreEssenceGeneratorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.EMRE_ESSENCE_GENERATOR_MENU.get(), pContainerId);
        checkContainerSize(inv, 1);
        blockEntity = ((EmreEssenceGeneratorBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.EMRE_ESSENCE_GENERATOR.get());
    }
